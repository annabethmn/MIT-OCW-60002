...
##    suite.addTest(unittest.makeSuite(ps3_P1A)) passed
##    suite.addTest(unittest.makeSuite(ps3_P1B)) passed
##    suite.addTest(unittest.makeSuite(ps3_P2_ER)) passed
##    suite.addTest(unittest.makeSuite(ps3_P2_FR)) passed
##    suite.addTest(unittest.makeSuite(ps3_P3)) passed
##    suite.addTest(unittest.makeSuite(ps3_P5_Standard)) passed
